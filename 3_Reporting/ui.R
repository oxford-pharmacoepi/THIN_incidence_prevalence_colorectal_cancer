    ...
    tabItems(
      ...
      tabItem(
        ...
        tags$h5("The analysis code used to generate these results can be found",
                tags$a(href="https://github.com/oxford-pharmacoepi/THIN_incidence_prevalence_colorectal_cancer", "here"),
        ...
        tags$h5("Any questions regarding this shiny app please contact",
                tags$a(href="mailto:patri.pedregalpascual@ndorms.ox.ac.uk", "Patri Pedregal-Pascual"), "and any questions regarding this study please contact the corresponding author",
